...
test('Props parent', async () => {
    ...
    assert.equal(wrapper.find('.root-text').text(), 'root:0');
    assert.equal(wrapper.find('.child-text').text(), 'child:0');
    ...
    assert.equal(wrapper.find('.root-text').text(), 'root:1');
    assert.equal(wrapper.find('.child-text').text(), 'child:1');
});
